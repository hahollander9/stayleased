...
export const PERMISSIONS: Record<string, string[]> = {
  ...
  reserves: ['view', 'manage', 'approve'], // replacement reserves: plans, draws, draw approval
  owners: ['view', 'manage'], // owner entities + ownership shares + owner statements
  budgets: ['view', 'manage'],
...
export const ROLE_PERMS: Record<Role, string[]> = {
  ...
  REGIONAL_MANAGER: [
    ...
    'gl:view', 'ap:view', 'ap:approve', 'banking:view', 'reserves:view', 'reserves:approve', 'owners:view', 'budgets:view', 'budgets:manage',
  ...
  PROPERTY_MANAGER: [
    ...
    'gl:view', 'ap:view', 'ap:manage', 'reserves:view', 'budgets:view',
  ...
  ACCOUNTANT: [
    ...
    'ledger:*', 'payments:*', 'latefees:waive', 'deposits:manage', 'collections:manage',
    'gl:*', 'ap:*', 'banking:*', 'reserves:*', 'owners:*', 'budgets:*',
