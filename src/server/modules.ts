...
import * as m9cap from '../modules/m9_accounting/pages_capital.ts'; // reserves + owners // also registers reserve_funding job
...
export function registerModules(r: Router): void {
  ...
  m9cap.routes(r); // Phase 19: replacement reserves + owner statements (accountant feedback)
  ...
  featureRoutes(r); // /platform, /resident, /agents, /for, /legal marketing pages
}
